 ...
 */
public class adapter_Database extends SQLiteOpenHelper
{
  static String TAG = "[AdapterDatabase]";
  public static final String databasename = "tasklist.sqlite";
  public static final String databaselocation = "/data/data/com.smart_tbk.fz/databases/";
  ...
  public adapter_Database(Context context)
  {
